...
!function(t){function a(t,a,n,s){var i=0;i=n.hasClass("to-right")?100:-100,n.css({"-webkit-transform":"translateX("+i+"%)","-moz-transform":"translateX("+i+"%)","-ms-transform":"translateX("+i+"%)","-o-transform":"translateX("+i+"%)",transform:"translateX("+i+"%)"}),s.css({opacity:1}),a.css({opacity:0}),setTimeout(function(){a.fadeOut(0),s.fadeIn(800)},800)}function n(t,a,n,s){s.css({opacity:0}),s.fadeOut(200),a.fadeIn(0),a.css({opacity:1}),n.css({"-webkit-transform":"translateX(0)","-moz-transform":"translateX(0)","-ms-transform":"translateX(0)","-o-transform":"translateX(0)",transform:"translateX(0)"})}t(document).ready(function(){t(".fading-box .details.block").fadeOut(0),t("#page-partners .references-box ul").each(function(){t(this).addClass("col-md-4"),t(this).find("li a").each(function(){t(this).attr("target","_blank")})}),t(".owl-carousel").owlCarousel({loop:!1,margin:30,nav:!0,dots:!1,responsive:{0:{items:1},600:{items:3},1e3:{items:4}},navText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>']}),t("#nav-icon3").click(function(){t(this).toggleClass("open")}),t(".to-detail-btn").click(function(n){var s=t(this).closest(".fading-box"),i=s.find(".intro").first(),o=i.find(".animation.translate").first(),r=s.find(".details").first();a(s,i,o,r)}),t(".to-intro-btn").click(function(a){var s=t(this).closest(".fading-box"),i=s.find(".intro").first(),o=i.find(".animation.translate").first(),r=s.find(".details").first();n(s,i,o,r)})});var s=(t("#cog"),t(document.body)),i=s.height();t(window).scroll(function(){t(".hexagon").css({transform:"rotate("+s.scrollTop()/i*360+"deg)"})})}(jQuery);